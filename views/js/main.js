...
var resizePizzas = function(size) {
  ...
  // Changes the value for the size of the pizza above the slider
    // Changed querySelector to getElementById for each case
  ...
  function changePizzaSizes(size) {
    ...
    var randomPizzaCount = document.getElementsByClassName("randomPizzaContainer").length;
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var cols = 8;
  var s = 256;
  // Changed i < 200 to i < 24 because the remaining iterations drew unseen pizzas
  for (var i = 0; i < 24; i++) {
